...
public class CreateSeed {
  ...
  private void executeSqlFile(String filePath) {
    try {
      ...
      System.err.println("Error ao executar o arquivo " + error.getMessage());
    }
  }
  // Importante mencionar que ao reconstruir algumas partes abaixo, complementam com o principal a ser executado.
}

          ...
          <form action='' onSubmit={handleSaveNote} className='flex-1 flex flex-col'>
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              {shouldShowOnboarding ? (
                  <p className='text-sm leading-6 text-slate-400'>
                    Comece gravando <button className='font-medium text-lime-400 hover:underline'>uma nota em áudio</button> ou se preferir <button onClick={handleStartEditor} className='font-medium text-lime-400 hover:underline'>utilize apenas texto</button>.
                  </p>
              ) : (
            ...
            <button type="submit" className='w-full bg-lime-400 py-4 text-center text-sm text-line-950 outline-none font-medium hover:bg-lime-500'>
              Salvar nota
            </button>
          </form>  
        </Dialog.Content>
